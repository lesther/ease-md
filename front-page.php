            ...
            <div class="col-12 col-lg-5">
                <div class="d-flex align-items-center">
                    <div class="text-center text-lg-start py-lg-4">
                        ...
                        <h3 class="title_sm title_lg--md h-line-height-sm-1 title_light title_spacing-lg h-max-width-sm-1--lg pe-3">
            ...
            <div class="row">
                    ...
                    <article class="options__item">
                        ...
                        <ul class="options__list">
                            <li class="options__list-item">
                                <span>Consultas médicas 24/7</span>
                            </li>
                            <li class="options__list-item">
                                <span>Psicología ilimitada</span>
                            </li>
                            <li class="options__list-item"> 
                                <span>Descuentos en red de especialistas</span>
                            </li>
                            <li class="options__list-item">
                                <span>Descuentos en farmacia</span>
                            </li>
                            <li class="options__list-item">
                                <span>Descuentos con nutriólogos</span>
                            </li>
                            <li class="options__list-item">
                                <span>Descuentos en clínicas dentales</span>
                            </li>
                            <li class="options__list-item">
                                <span>Descuentos en ópticas</span>
                            </li>
                            <li class="options__list-item">
                                <span>Descuentos en laboratorio</span>
                            </li>
                            <li class="options__list-item">
                                <span>Laboratorio a domicilio</span>
                            </li>
                            <li class="options__list-item">
                                <span>Descuentos en fisioterapia</span>
                            </li>
                            <li class="options__list-item">
                                <span>Descuentos en wellness</span>
                            </li>
                        </ul>
                        <p class="h-spacing-top-lg text_sm text_align-center">
                            Incluye a niños menores de 16 años y adultos de la tercera edad sin costo por plan individual.
                        </p>
                        <p class="text_sm text_align-center text_weight-bold">
                            *Tarifa variable según el país de contratación.
                        </p>
                        <div class="mt-auto">
                ...
                <div class="col-12 col-md-6">
                    <article class="options__item">
                        ...
                        <p class="h-spacing-top-lg text_sm text_align-center">
                            <b>Ahorra $11.85 al mes</b> y ¡complarte tu plan hasta con 3 personas más!
                        </p>
                        <p class="text_sm text_align-center text_weight-bold">
                            *Tarifa variable según el país de contratación.
                        </p>
